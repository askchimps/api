...
export class PatchCreditsDto {
    ...
    @ValidateIf((o) => o.operation === CreditOperation.INCREMENT || o.operation === CreditOperation.DECREMENT)
    @IsDefined({ message: 'amount is required for increment/decrement operations' })
    @Type(() => Number)
